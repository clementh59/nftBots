...
const collectionToSpecialFunction = {
    'terra1f89xq3qhu98v4jch4y5xcrkhl9gytrne99x74t': [ // terrapins
        ...
        // Dragon hats
        {trait_type: 'head', value: 'Dagon Hat - Purple - Laser', triggerValue: 6, maxFloorValueInCollectionFloor: 15},
        {trait_type: 'head', value: 'Dragon Hat - Green', triggerValue: 1.2, maxFloorValueInCollectionFloor: 3},
        {trait_type: 'head', value: 'Dragon Hat - Red', triggerValue: 1.2, maxFloorValueInCollectionFloor: 3},
        {trait_type: 'head', value: 'Dragon Hat - Purple', triggerValue: 1.2, maxFloorValueInCollectionFloor: 3},

        {trait_type: 'body', value: 'Genesis', triggerValue: 25, maxFloorValueInCollectionFloor: 40},
        {trait_type: 'body', value: 'Kimono', triggerValue: 1.1, maxFloorValueInCollectionFloor: 1.6},
        {trait_type: 'body', value: 'Kings Robe', triggerValue: 1.1, maxFloorValueInCollectionFloor: 1.2},
        {trait_type: 'body', value: 'Suit of Armour', triggerValue: 2.5, maxFloorValueInCollectionFloor: 2},
        {trait_type: 'eyes', value: 'Cyborg - Laser', triggerValue: 1.3, maxFloorValueInCollectionFloor: 2},
        ...
        {trait_type: 'head', value: 'Pylon Helmet', triggerValue: 7, maxFloorValueInCollectionFloor: 15},
        ...
        {trait_type: 'head', value: 'Bunny Ears - Brown', triggerValue: 3, maxFloorValueInCollectionFloor: 4},
        {trait_type: 'head', value: 'Bunny Ears - White', triggerValue: 3, maxFloorValueInCollectionFloor: 4},
